...
1. 安装 `AuroraShelf-2.12.0-multisource.apk`；与上一版包名和测试签名一致，可直接覆盖更新。
...
这是使用开发证书签名的内部测试候选包，不应作为官方商店发行包。桌面交付文件 SHA-256：`59f4cf487204043c4b8067521884c9b4813b8b4ff8b359fdfeb3b132c5849436`。
