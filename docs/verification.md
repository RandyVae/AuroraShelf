...
1. 安装 `AuroraShelf-2.12.1-image-fix.apk`；与上一版包名和测试签名一致，可直接覆盖更新。
...
这是使用开发证书签名的内部测试候选包，不应作为官方商店发行包。桌面交付文件 SHA-256：`8f5ad2ac94a1ee4d0545bd50bc5f7aa0a454617102f06885c40a3b358e082b6f`。
